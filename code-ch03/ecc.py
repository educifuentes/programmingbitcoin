...
class ECCTest(TestCase):
    ...
    def test_add(self):
        ...
        for x1, y1, x2, y2, x3, y3 in additions:
            x1 = FieldElement(x1, prime = prime)
            y1 = FieldElement(y1, prime = prime)
            x2 = FieldElement(x2, prime = prime)
            y2 = FieldElement(y2, prime = prime)
            x3 = FieldElement(x3, prime = prime)
            y3 = FieldElement(y3, prime = prime)
